<template>
    <div id="container2">
        ...
        <p class="sub-text">By providing your credentials you are asking Alice to retrieve your financial data and agree to our <a id="tosLink" href="https://sophtron.com/Home/Terms" target="_blank" >terms of service</a>.</p>
        <div class="pb-2">
